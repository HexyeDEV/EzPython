...
req = requests.get("https://raw.githubusercontent.com/HexyeDev/EzPython/master/version.json").json()

if req['version'] != current_version:
    messagebox.showinfo("Update", "Update available, Installing it Now")
    new_file = requests.get("https://raw.githubusercontent.com/HexyeDev/EzPython/master/EzPython.py").text
